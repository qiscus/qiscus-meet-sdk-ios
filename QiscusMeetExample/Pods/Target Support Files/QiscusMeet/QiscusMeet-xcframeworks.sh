...
install_xcframework "${PODS_ROOT}/../../SDK/JitsiMeetSDK.xcframework" "QiscusMeet" "framework" "ios-x86_64-simulator" "ios-arm64"
install_xcframework "${PODS_ROOT}/../../SDK/WebRTC.xcframework" "QiscusMeet" "framework" "ios-arm64" "ios-x86_64-simulator"
